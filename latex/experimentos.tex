...
Estados Unidos y Londres sería demasiado rápido.\\

Además tenemos identificado un posible salto continental en 208.178.195.213 - 67.17.99.233.
Sin embargo esto es incorrecto ya que ambas IP pertenecen al dominio de Estados Unidos. El salto continental se produce entre 6 y 9, aunque
si vemos el gráfico de RTTs podemos apreciar que la diferencia no es muy grande. Aunque creemos que
esto es correcto ya que, como mencionamos antes, el hops 6 debe ser de Netherlands en vez de Estados
Unidos.
